...
# This was moved earlier in the include sequence because we needed
# to delay including envsetup.mk until after the HW_CONFIG was set
...
# Motorola BEGIN - jsuttles - IKMAIN-5682
# This was moved later in the include sequence so that we could ensure
# HW_CONFIG was set before including
