...
# If $(TARGET_OUT_INTERMEDIATES)/motorola/security/moto_crypto/moto_crypto.ko exists, this is the kernel module for FIPS feature
# Use python tool to work out the hmac sha256 value and save it to file /system/etc/.moto_crypto_hmac_sha256
	@if [ -f $(TARGET_OUT_INTERMEDIATES)/motorola/security/moto_crypto/moto_crypto.ko ]; then \
	    (motorola/security/moto_crypto/scripts/fips_module_hmac.py 3c091d83745f3ed32cab47458950bca648561bc54d738fe5ee34235ff1100d4a \
	    < $(TARGET_OUT_INTERMEDIATES)/motorola/security/moto_crypto/moto_crypto.ko) \
	    > $(TARGET_OUT_ETC)/.moto_crypto_hmac_sha256; \
	    echo "Install: $(TARGET_OUT_ETC)/.moto_crypto_hmac_sha256"; \
	fi
